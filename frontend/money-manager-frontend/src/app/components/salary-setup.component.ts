...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-8 sm:py-12 px-3 sm:px-4">
      <div class="max-w-md w-full">
        <!-- Header Section - Responsive -->
        <div class="text-center mb-6 sm:mb-8">
          <div class="mx-auto w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 shadow-lg">
          ...
          <p class="mt-2 text-sm sm:text-base text-gray-600">Enter your monthly salary to get started</p>
        </div>

        <!-- Form Container - Responsive -->
        <div class="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8">
          <form [formGroup]="salaryForm" (ngSubmit)="onSubmit()" class="space-y-4 sm:space-y-6">
            <!-- Salary Input - Responsive -->
            <div>
